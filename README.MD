...
az deployment group create -n InitialNetwrok \
-g $rg \
--mode Incremental \
...
## To Do
1. Investigate how to use managed identity for the logic app to pull image from Azure Container Registry 
